---
description: "Use this agent to generate marketing content. This includes blog posts, social media posts, video scripts, ad copy, landing page copy, and newsletter content."
mode: subagent
tools:
  read: true
  write: true
