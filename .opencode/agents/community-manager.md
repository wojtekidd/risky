---
description: "Use this agent for Discord/Slack moderation and community engagement. This includes sentiment analysis, response drafting, moderation alerts, engagement metrics, and FAQ generation."
mode: subagent
tools:
  read: true
  write: true
