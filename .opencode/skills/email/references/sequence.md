...
```bash
node .opencode/skills/brand/scripts/inject-brand-context.cjs --json
```
...
- `.opencode/skills/email/references/automation-flows.md`
- `.opencode/skills/email/references/subject-line-formulas.md`
- `.opencode/skills/email/references/email-templates.md`
