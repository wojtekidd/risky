...
- **Art Direction**: use `AskUserQuestion` tool to suggest a few style preferences from video-art-directions reference of `video` skill, include "Feel free to suggest your own style" option.
...
- If relevant, run `node .opencode/skills/brand/scripts/inject-brand-context.cjs --json` and incorporate:
  - Tone of voice
