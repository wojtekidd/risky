...
```bash
python3 .opencode/skills/ai-artist/scripts/search.py "product shot ad" --domain examples
python3 .opencode/skills/ai-artist/scripts/search.py "lifestyle marketing" --domain style
```
