...
def main():
    ...
    if all_passed:
        ...
        print("  • gemini-3.1-flash-image-preview - Nano Banana 2 (DEFAULT - fastest, near-Pro quality)")
        print("  • gemini-2.5-flash-image         - Nano Banana Flash (previous default, stable)")
