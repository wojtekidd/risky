---
description: "Convert YouTube video to multi-platform social posts - Args: <youtube-url> [platforms]"
---
...
1. **Extract Video Highlights**
   ...
   - Run VidCap API:
     ...
     python .opencode/skills/youtube-handling/scripts/vidcap.py comments "<url>" --order relevance
