---
description: "Marketing playbook orchestrator — expert strategy, AI execution, goal tracking - Args: [create|next|status|list|blocked|learn|reset|gate|templates|goals] [args]"
---
