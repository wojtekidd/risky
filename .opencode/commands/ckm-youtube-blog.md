---
description: "Convert YouTube video to SEO-optimized blog post - Args: <youtube-url> [writing-style]"
---
...
1. **Extract Video Content**
   ...
   - Run VidCap API:
     ...
     python .opencode/skills/youtube-handling/scripts/vidcap.py article "<url>"

     # Or custom extraction for more control
     python .opencode/skills/youtube-handling/scripts/vidcap.py summary-custom "<url>" \
