---
description: "Generate copy using proven copywriting formulas (AIDA, PAS, BAB, etc.) - Args: <formula> \"<topic>\""
---
...
- `.opencode/skills/copywriting/references/copy-formulas.md`
- `.opencode/skills/copywriting/references/power-words.md`
