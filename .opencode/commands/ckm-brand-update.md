---
description: "🎨 Update brand identity and sync to all design systems - Args: [theme-name] or interactive"
---
...
Run the sync script:
```bash
node .opencode/skills/brand-guidelines/scripts/sync-brand-to-tokens.cjs
```
...
node .opencode/skills/brand-guidelines/scripts/inject-brand-context.cjs --json | head -30
