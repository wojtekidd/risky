---
description: "Generate complete email drip sequence with copy - Args: <type> \"[context]\""
---
...
- `.opencode/skills/email-marketing/references/automation-flows.md`
- `.opencode/skills/email-marketing/references/subject-line-formulas.md`
- `.opencode/skills/email-marketing/references/email-templates.md`
