---
description: "Run workflow tests with step-by-step manual verification - Args: [workflow: youtube|content|email|brand|all]"
---
...
```bash
python3 .opencode/skills/test-orchestrator/scripts/scan-components.py --json --scenarios
```
