---
description: "💡💡 Generate SEO-optimized blog article from YouTube video - Args: ['youtube-url']"
---
...
python .opencode/skills/youtube-handling/scripts/vidcap.py caption "$URL" --locale en --ext vtt
```
