---
description: "💡💡 Technical SEO audit - Args: ['url']"
---
...
2. **ReviewWeb API Analysis** (if `$REVIEWWEB_API_KEY` available)
   - Reference: `.opencode/skills/seo-optimization/references/reviewweb-api.md`
...
## API Reference
- ReviewWeb API: `.opencode/skills/seo-optimization/references/reviewweb-api.md`
