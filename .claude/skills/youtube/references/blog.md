...
1. **Extract Video Content**
   ...
   - Run VidCap API:
     ...
     python .claude/skills/youtube/scripts/vidcap.py article "<url>"

     # Or custom extraction for more control
     python .claude/skills/youtube/scripts/vidcap.py summary-custom "<url>" \
       --prompt "Extract main points, key quotes, and actionable insights"

     # Get captions for quotes
     python .claude/skills/youtube/scripts/vidcap.py caption "<url>" --ext vtt
     ```
